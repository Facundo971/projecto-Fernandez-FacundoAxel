    ...
    <div class="bg-light rounded-2 pt-3">
        ...
        <div class="row ms-5 me-5">
            ...
            <div class="col-12 text-center border-bottom">
                <img src="<?= base_url('assets/img/icons8-delivery-time-48.png'); ?>" alt="Icono 1" width="60px" height="60px">
            ...
            <div class="col-12 border-bottom">
                <div class="row">
                    <div class="col-6 text-center">
                        <img src="<?= base_url('assets/img/icons8-delivery-50.png'); ?>" alt="Icono 2" width="60px" height="60px">
                        <p>Entrega <b>GRATIS</b> en domicilio</p>
                    </div>
                    <div class="col-6 text-center">
                        <img src="<?= base_url('assets/img/icons8-shop-location-48.png'); ?>" alt="Icono 3" width="60px" height="60px">
