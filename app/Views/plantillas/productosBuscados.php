            ...
            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-5">
                <div class="row">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <form action="<?php echo base_url('enviar-formPrecioBuscador/' . $valorQuery); ?>" method="GET">
                ...
                <div class="mt-1 border-bottom d-flex justify-content-end">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?php echo base_url('productosMayorPrecioBuscador/' . $valorQuery); ?>"><b>Mayor Precio</b></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('productosMenorPrecioBuscador/' . $valorQuery); ?>"><b>Menor Precio</b></a></li>
                        </ul>
                    </div>
                </div>
