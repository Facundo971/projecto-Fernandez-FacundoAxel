<footer class="border">
    <div class="container text-center pb-2 border-bottom">
        <div class="row ps-5 pe-5 pt-2">
            ...
            <div class="col">
                <p class="text-start"><b>Atención al cliente:</b><br><span class="opacity-75">+54 9 3794 04 6207<br>+54 9 3794 91 6905</span></p>
            </div>
            <div class="col">
                <p class="text-start"><b>Horario de Atencion:</b><br><span class="opacity-75">LU-VI de 09:00 a 18:00 <br> SA de 9:00 a 13:00</span></p>
            </div>
            <div class="col">
                <div>
                    <p class="text-start"><b>Redes Sociales</b></p>
                </div>
        ...
        <div class="row ps-5 pe-5 pt-2">
            ...
            <div class="col text-start">
                <ul class="list-unstyled">
                    ...
                    <li><a href="<?php echo base_url('ayuda#contacto'); ?>" class="text-dark text-decoration-none opacity-75">Contacto</a></li>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <p class="opacity-75 pt-3">&copy; 2025 NetShop | Todos los derechos reservados | País: Argentina | Provincia: Corrientes | Localidad: Corrientes Capital</p>
    </div>
</footer>
