<?php
    ...
    $valorUsuarioQuery = $session->getFlashdata('usuarioQueryValor');
?>
...
<main class="conteiner__listaDeUsuarios">
    ...
    <div class="bg-white rounded-2">
        ...
        <div class="d-flex justify-content-end pb-2 pe-2">
            <a href= "<?php echo base_url('mostrarListaUsuariosDesactivados'); ?>" class="btn btn-danger text-white rounded-2"><b>Desactivos</b></a>
        </div>
        <div class="listaDeUsuarios-scroll">
            ...
            <?php if($boleano == true): ?>
                <div class="bg-white pt-5 pb-5 border-top">
                    ...
                    <h4 class="text-center ps-4 pe-4"><b>Ups, parece que aún no se ha agregado ningún usuario</b></h4>
