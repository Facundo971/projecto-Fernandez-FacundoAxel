...
<main class="conteiner__listaDePerfiles">
    <div class="bg-white rounded-2">
        ...
        <div class="d-flex justify-content-end pb-2 pe-2">
            <a href= "<?php echo base_url('mostrarListaPerfilesActualizarEliminar'); ?>" class="btn btn-secondary text-white rounded-2"><b>Volver</b></a>
        </div>
                ...
                <?php foreach($perfiles as $perfil): ?>
                    <?php if($perfil['baja'] == 'SI'): ?>
                        <div class="row w-100 ms-0 border-top">
                            ...
                            <div class="col-4 pb-3 pt-3 border-end d-flex justify-content-center align-items-center"> 
                                <a href= "<?php echo base_url('activarPerfiles/' . $perfil['id_perfil']); ?>" class="btn btn-primary text-white rounded-2"><b>Activar</b></a>
                            </div>
                        </div>
                    <?php endif; ?>
                <?php endforeach; ?>
